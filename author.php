            ...
            <div class="col-md-8">
                 ...
                 <div class="post-container">
                  ...
                  <?php
                        ...
                        $sql2 = "SELECT * FROM user JOIN post
                            ON post.author = user.user_id
                            WHERE post.author={$auth}";
                            $result2 = mysqli_query($connect,$sql2);
                            $rows = mysqli_fetch_assoc($result2);

                            echo "<h2 class='page-heading'>{$rows['username']}</h2>";
                    ...
                    ?>
                        ...
                        <?php
                            ...
                            if (mysqli_num_rows($result2) > 0) {
                                ...
                                if ($page > 1) {
                                    echo '<li><a href="index.php?apj='.$auth.'&page='.($page - 1).'">Prev</a></li>';
                                }
                                for ($i=1; $i <= $total_pages; $i++) { 
                                    ...
                                    echo '<li class="'.$active.'"><a href="index.php?apj='.$auth.'&page='.$i.'">'.$i.'</a></li>';
                                }
                                if ($total_pages > $page) {
                                    echo '<li><a href="index.php?apj='.$auth.'&page='.($page + 1).'">Next</a></li>';
                                }
                                echo "</ul>";    
                            } 
                        ?>
